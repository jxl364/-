            ...
            <div class="navbar-inner filter">
              <ul class="sui-nav">
                <li :class="{ active: isOne }" @click="changeOrder('1')">
                  <a
                    >综合<span v-show="isOne">{{ judge }}</span></a
                  >
                </li>
                <li :class="{ active: isTwo }" @click="changeOrder('2')">
                  <a
                    >价格<span v-show="isTwo">{{ judge }}</span></a
                  >
                </li>
              </ul>
            </div>
...
export default {
  ...
  methods: {
    ...
    changeOrder(index) {
      if (index == this.searchParams.order.split(":")[0]) {
        ...
        if (index == "1") {
          this.searchParams.order = this.searchParams.order.replace("2", index);
          this.getData()
        } else {
          this.searchParams.order = this.searchParams.order.replace("1", index);
          this.getData()
        }
      }
    },
